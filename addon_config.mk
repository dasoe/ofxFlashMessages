...
meta:
	ADDON_NAME = ofxFlashMessages
	ADDON_DESCRIPTION = Flash Messages (Popup Messages showing something for some time then vanishing)
	ADDON_AUTHOR = dasoe
	ADDON_TAGS = "Flash Messages" "popup" 
	ADDON_URL = http://github.com/dasoe/ofxFlashMessages
	ADDON_PLATFORMS = vs
